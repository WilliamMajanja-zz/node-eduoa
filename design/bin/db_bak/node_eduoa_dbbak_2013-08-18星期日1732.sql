...
CREATE TABLE `cms_article` (
  ...
  `article_state` int(11) default NULL COMMENT '发布状态（0：未发布；1：已发布；2：已撤回）',
...
INSERT INTO `cms_article` VALUES (2,1,'测试22','啊实打实的阿斯顿撒222','2013-08-18 17:21:27',1,'2013-08-18 17:21:27',1,NULL,13,'notice.txt',NULL,NULL,NULL,'林锋','林锋'),(3,2,'测试校园动态','校园动态','2013-08-18 17:22:13',1,'2013-08-18 17:22:13',1,NULL,NULL,NULL,NULL,NULL,NULL,'林锋','林锋'),(4,3,'测试学习园地','学习园地','2013-08-18 17:22:34',1,'2013-08-18 17:22:34',1,NULL,NULL,NULL,NULL,NULL,NULL,'林锋','林锋'),(5,4,'测试政策法规','测试政策法规','2013-08-18 17:22:47',1,'2013-08-18 17:22:47',1,NULL,NULL,NULL,NULL,NULL,NULL,'林锋','林锋'),(6,5,'测试活动公告','测试活动公告','2013-08-18 17:22:59',1,'2013-08-18 17:22:59',1,NULL,NULL,NULL,NULL,NULL,NULL,'林锋','林锋'),(7,6,'测试教师风采','测试教师风采','2013-08-18 17:23:10',1,'2013-08-18 17:23:10',1,NULL,NULL,NULL,NULL,NULL,NULL,'林锋','林锋');
...
CREATE TABLE `cms_article_teacher` (
  ...
  PRIMARY KEY  (`id`),
  KEY `FK61C20EA3BEBF3077` (`article_id`),
  CONSTRAINT `FK61C20EA3BEBF3077` FOREIGN KEY (`article_id`) REFERENCES `cms_article` (`id`)
...
INSERT INTO `cms_channel` VALUES (1,'教育新闻',1,NULL,'jyxw'),(2,'校园动态',2,NULL,'xydt'),(3,'学习园地',3,NULL,'xxyd'),(4,'政策法规',4,NULL,'zcfg'),(5,'活动公告',5,NULL,'hdgg'),(6,'教师风采',6,NULL,'jsfc');
/*!40000 ALTER TABLE `cms_channel` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_city`
--

DROP TABLE IF EXISTS `fw_city`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fw_city` (
  `id` bigint(20) NOT NULL auto_increment,
  `city_cn` varchar(255) default NULL,
  `city_en` varchar(255) default NULL,
  `country_aliases_cn` varchar(255) default NULL,
  `country_aliases_en` varchar(255) default NULL,
...
--
-- Dumping data for table `fw_city`
--

LOCK TABLES `fw_city` WRITE;
/*!40000 ALTER TABLE `fw_city` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_city` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_class`
--

DROP TABLE IF EXISTS `fw_class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fw_class` (
  `id` bigint(20) NOT NULL auto_increment,
...
--
-- Dumping data for table `fw_class`
--

LOCK TABLES `fw_class` WRITE;
/*!40000 ALTER TABLE `fw_class` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_class` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_commodity`
--

DROP TABLE IF EXISTS `fw_commodity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fw_commodity` (
  `id` bigint(20) NOT NULL auto_increment,
  `commodity_code` varchar(100) default NULL,
  `commodity_name_cn` varchar(100) default NULL,
  `commodity_name_en` varchar(200) default NULL,
  `container_type` varchar(255) default NULL,
  `container_type_id` varchar(255) default NULL,
  `customs_code` varchar(100) default NULL,
  `description_cn` varchar(300) default NULL,
  `description_en` varchar(300) default NULL,
  `gw` float default NULL,
  `image_url` varchar(255) default NULL,
  `legal_units` varchar(20) default NULL,
  `legal_units_percent` float default NULL,
  `net_weight` float default NULL,
  `package_unit_cn` varchar(20) default NULL,
  `package_unit_en` varchar(50) default NULL,
  `sales_unit_cn` varchar(20) default NULL,
  `sales_unit_en` varchar(50) default NULL,
  `second_legal_units` varchar(20) default NULL,
  `second_legal_units_percent` float default NULL,
...
--
-- Dumping data for table `fw_commodity`
--

LOCK TABLES `fw_commodity` WRITE;
/*!40000 ALTER TABLE `fw_commodity` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_commodity` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_container`
--

DROP TABLE IF EXISTS `fw_container`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fw_container` (
  `id` bigint(20) NOT NULL auto_increment,
  `container_code` varchar(255) default NULL,
  `container_size` varchar(255) default NULL,
  `container_type` varchar(255) default NULL,
  `max_volume` varchar(255) default NULL,
...
--
-- Dumping data for table `fw_container`
--

LOCK TABLES `fw_container` WRITE;
/*!40000 ALTER TABLE `fw_container` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_container` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_country`
--

DROP TABLE IF EXISTS `fw_country`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `fw_country`
--

LOCK TABLES `fw_country` WRITE;
/*!40000 ALTER TABLE `fw_country` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_country` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_dictionary`
--

DROP TABLE IF EXISTS `fw_dictionary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `fw_dictionary`
--

LOCK TABLES `fw_dictionary` WRITE;
/*!40000 ALTER TABLE `fw_dictionary` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_dictionary` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_dictionary_val`
--

DROP TABLE IF EXISTS `fw_dictionary_val`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fw_dictionary_val` (
  `id` bigint(20) NOT NULL auto_increment,
  `dictionary_code` varchar(255) default NULL,
  `dictionary_label` varchar(255) default NULL,
  `dictionary_id` bigint(20) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKC9C531264EA6DEC0` (`dictionary_id`),
  CONSTRAINT `FKC9C531264EA6DEC0` FOREIGN KEY (`dictionary_id`) REFERENCES `fw_dictionary` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fw_dictionary_val`
--

LOCK TABLES `fw_dictionary_val` WRITE;
/*!40000 ALTER TABLE `fw_dictionary_val` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_dictionary_val` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_exchange_rate`
--

DROP TABLE IF EXISTS `fw_exchange_rate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fw_exchange_rate` (
  `id` bigint(20) NOT NULL auto_increment,
  `currency_cn` varchar(255) default NULL,
...
--
-- Dumping data for table `fw_exchange_rate`
--

LOCK TABLES `fw_exchange_rate` WRITE;
/*!40000 ALTER TABLE `fw_exchange_rate` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_exchange_rate` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_port`
--

DROP TABLE IF EXISTS `fw_port`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fw_port` (
  `id` bigint(20) NOT NULL auto_increment,
  `country_aliases_cn` varchar(255) default NULL,
  `country_aliases_en` varchar(255) default NULL,
  `country_id` bigint(20) default NULL,
  `port_aliases_cn` varchar(255) default NULL,
  `port_aliases_en` varchar(255) default NULL,
  `port_cn` varchar(255) default NULL,
  `port_en` varchar(255) default NULL,
...
--
-- Dumping data for table `fw_port`
--

LOCK TABLES `fw_port` WRITE;
/*!40000 ALTER TABLE `fw_port` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_port` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_route_port`
--

DROP TABLE IF EXISTS `fw_route_port`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fw_route_port` (
  `id` bigint(20) NOT NULL auto_increment,
  `port_aliases_cn` varchar(255) default NULL,
  `port_aliases_en` varchar(255) default NULL,
...
--
-- Dumping data for table `fw_route_port`
--

LOCK TABLES `fw_route_port` WRITE;
/*!40000 ALTER TABLE `fw_route_port` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_route_port` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fw_sail_number`
--

DROP TABLE IF EXISTS `fw_sail_number`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fw_sail_number` (
  `id` bigint(20) NOT NULL auto_increment,
  `company_aliases_en` varchar(255) default NULL,
  `company_id` bigint(20) default NULL,
  `export_sail_no` varchar(255) default NULL,
  `import_sail_no` varchar(255) default NULL,
  `sail_no` varchar(255) default NULL,
  `sailing_date` datetime default NULL,
  `sailing_date_long` bigint(20) default NULL,
...
--
-- Dumping data for table `fw_sail_number`
--

LOCK TABLES `fw_sail_number` WRITE;
/*!40000 ALTER TABLE `fw_sail_number` DISABLE KEYS */;
/*!40000 ALTER TABLE `fw_sail_number` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `oa_score` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='成绩表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oa_student_class` VALUES (3,11,9,'2012-09-01 00:00:00','2013-02-01 00:00:00',2013),(4,12,9,'2012-09-01 00:00:00','2013-02-01 00:00:00',2013),(5,11,10,'2012-09-01 00:00:00','2013-02-01 00:00:00',2013);
...
-- Dump completed on 2013-08-18 17:32:24

 ...
 */
public interface CertificateTypeDAO extends JpaRepository<OaCertificateType, Long> {

	Page<OaCertificateType> findByTypeNameContaining(String typeName, Pageable pageable);

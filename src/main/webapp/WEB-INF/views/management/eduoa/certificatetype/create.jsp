...
<div class="pageContent">
    <form method="post" action="${contextPath }/management/eduoa/certificatetype/create" class="required-validate pageForm"
          onsubmit="return validateCallback(this, dialogReloadNavTab);">
        <div class="pageFormContent" layoutH="58">
            <p>
                <label>职称证书：</label>
                <input type="text" name="typeName" class="required" size="32" maxlength="32" />
            </p>

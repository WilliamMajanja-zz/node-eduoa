...
<script type="text/javascript">
	$(document).ready(function(){
	    var chart3 = new FusionCharts("${contextPath }/styles/fusionchart/FusionCharts/Column2D.swf", "ChartId", "500", "300", "0", "0");
	    chart3.setXMLData("${result}");
	    chart3.render("chartdiv3");
	});
</script>

<form method="post" action="${contextPath }/management/eduoa/gradequery/list3" class="required-validate" 

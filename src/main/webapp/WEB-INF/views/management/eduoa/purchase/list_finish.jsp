...
<keta:paginationForm action="${contextPath }/management/eduoa/purchase/listFinish" page="${page }">
	<input type="hidden" name="keywords" value="${keywords}"/>
</keta:paginationForm>

<form method="post" action="${contextPath }/management/eduoa/purchase/listFinish" onsubmit="return navTabSearch(this)">

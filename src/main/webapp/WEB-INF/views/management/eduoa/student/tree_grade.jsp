		...
		if (grade.getChildren().isEmpty()) {
            ...
            for(OaClass oaClass : grade.getOaClassesById()) {
                subBudder.append("<li><a href=\"javascript:\" onclick=\"returnClose({classId:'"
                        + oaClass.getId() + "', className:'" + oaClass.getClassName() + "', gradeId:'"
                        + grade.getId() + "',gradeName:'" + grade.getGradeName() + "', startTime:'"
                        + simpleDateFormat.format(grade.getStartTime()) + "', endTime:'"
                        + simpleDateFormat.format(grade.getEndTime()) + "'})\" >"
